...
if __name__ == "__main__":
    ...
    # Animations
    utils.animate_points_by_x_perpendicular(df, abs=False, output_path=os.path.join(output_path, "animation_points_by_x_perpendicular.gif"))
    utils.animate_points_by_x_perpendicular(df, abs=True, output_path=os.path.join(output_path, "animation_points_by_abs_x_perpendicular.gif"))
